...
static const char *const yytname[] =
{
  ...
  "WHILE", "ID", "NUM", "LTE", "GTE", "EQUAL", "NOTEQUAL",
  "LOWER_THAN_ELSE", "';'", "'['", "']'", "'('", "')'", "','", "'{'",
  "'}'", "'='", "'<'", "'>'", "'+'", "'-'", "'*'", "'/'", "$accept",
...
{
       1,     8,     2,    11,    12,    10,    14,    13,    15,     9
};

static const yytype_uint8 yycheck[] =
{
       5,     0,     7,    16,    17,     9,    18,    10,    16,     4
};
